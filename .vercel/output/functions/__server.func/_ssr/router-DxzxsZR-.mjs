...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DxzxsZR-.js
var router_DxzxsZR__exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-monhDHz8.css";
var APP_NAME = "Puzzle Journey";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Drop blocks, clear lines, and chase combos on a tropical night island."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-CD3RbMvU.mjs");
...
//#endregion
export { getRouter, router_DxzxsZR__exports as t };
